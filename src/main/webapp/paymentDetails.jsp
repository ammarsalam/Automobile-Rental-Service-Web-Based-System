...
<head>
  ...
  <link rel="stylesheet" href="./content/css/paymentDetails.css">
...
<input type="checkbox" id="bars">
  ...
  <header class="home" id="home">
    <div class="content">
      <h1> PAYMENT <strong>DETAILS <br>	</strong>  <strong></strong> </h1>
      <h4>Add payment details for your booking</h4>  
    </div>
  </header>
  ...
  <section class="car-form-panel">
    ...
    <div class="car-form">
      <form action="addPaymentController" method="post" >
        ...
        <input type="submit" id="btn-submit" value="PAY" onclick="location.href='addPaymentController'">
...
function handlePayment() {
    // Perform any necessary actions (form submission, API call, etc.)
    // In this example, just display a pop-up message
