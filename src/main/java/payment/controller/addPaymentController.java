...
public class addPaymentController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		payment.setBooking_id(Integer.parseInt(request.getParameter("booking_id")));
	    ...
	    //request.setAttribute("payment", PaymentDAO.getBooking(BookingDAO.getLatestBookingID()));
